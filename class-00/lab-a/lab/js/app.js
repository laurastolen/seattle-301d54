...
function displayPics() {
  ...
  // Trying to console.log the variable `rando` threw an error because rando was declared in a while loop (ie a code block) so we can't access it from outside that block.
  console.log(viewed);
