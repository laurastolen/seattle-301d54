...
// The Student object named 'Joe'
// 2. What is "this" when joe.scopeArrow() is invoked?
// The Window object
// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions don't 'bind' to the `this` keyword, meaning that in an arrow fx, `this` bubbles up and references the window. In a fx declaration, `this` binds/refers to the enclosing function.
